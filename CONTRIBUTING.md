...
5. Open your browser to http://localhost:7301/god-mode/ and register yourself as instance admin
6. Open up your browser to http://localhost:7300 then log in using the same credentials from the previous step
